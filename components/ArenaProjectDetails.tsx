...
const ArenaProjectDetails = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Responsive Angular application with real-time data synchronization and intuitive user interface",
      icon: "/b5.svg"
    },
    {
      title: "Automated Workflows",
      description: "AWS Lambda-powered automated reminders and media uploads to S3 reducing communication gaps by 35%",
      icon: "/grid.svg"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-custom-olive mb-6">
                Arena is a comprehensive sports management platform built with Java Spring Boot
                backend and Angular frontend on AWS infrastructure, designed to streamline operations
                for sports organizations, teams, and facilities. The cloud-native architecture reduces
                manual roster and schedule tracking by 45%, providing an intuitive platform for managing
                everything from player rosters to event scheduling. Specifically designed for smaller teams
                such as church and small school organizations, Arena brings enterprise-grade functionality
                to organizations that need reliable sports management without the complexity of large-scale systems.
              </p>
              <p className="text-custom-olive mb-6">
                The system features a robust Spring Boot REST API with 12+ endpoints across 4 core entities,
                persisting structured data in AWS RDS for reliable CRUD operations. The Angular frontend
                provides a responsive and intuitive user experience with real-time data synchronization.
                Automated AWS Lambda workflows handle reminders and media uploads to S3, reducing
            ...
            <div className="relative">
              <div className="relative w-full h-96 bg-custom-darkOlive rounded-3xl p-4">
                <div className="w-full h-full bg-custom-olive/20 rounded-2xl flex flex-col items-center justify-center">
                  ...
                  <p className="text-custom-olive text-sm text-center mb-4">Placeholder for Arena demo video<br />showing Angular UI, Spring Boot API endpoints, and AWS integration</p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-12">
            <div>
              ...
              <div className="relative w-full h-80 bg-custom-darkOlive rounded-3xl p-4">
                <div className="w-full h-full bg-custom-olive/20 rounded-2xl flex flex-col items-center justify-center">
                  ...
                  <p className="text-custom-olive text-sm text-center">Placeholder for AWS architecture diagram<br />showing Spring Boot on EC2, RDS, S3, Lambda, and Angular deployment</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative w-full h-80 bg-custom-darkOlive rounded-3xl p-4">
                <div className="w-full h-full bg-custom-olive/20 rounded-2xl flex flex-col items-center justify-center">
                  <p className="text-custom-darkOlive font-bold text-xl mb-2">Spring Boot REST API</p>
                  <p className="text-custom-olive text-sm text-center">Placeholder for API documentation screenshot<br />showing 12+ Spring Boot endpoints across 4 core entities</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div key={index} className="flex flex-col items-center">
                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg mb-3">
                  <Image
                    src={tech.icon}
                    alt={tech.name}
                    width={tech.icon === "/java.svg" ? 36 : 32}
                    height={tech.icon === "/java.svg" ? 36 : 32}
                  />
                </div>
